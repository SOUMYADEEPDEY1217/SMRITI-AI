...
//#region node_modules/vanta/dist/vanta.fog.min.js
var require_vanta_fog_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		e.r(t), e.d(t, { default: () => u }), Number.prototype.clamp = function(e, t) {
		...
		n.VantaBase = class {
			constructor(e = {}) {
				...
				if (this.options = Object.assign({
					...
					scale: 1,
					scaleMobile: 1
				}, t), (e instanceof HTMLElement || "string" == typeof e) && (e = { el: e }), Object.assign(this.options, e), this.options.THREE && (s = this.options.THREE), this.el = this.options.el, null == this.el) r("Instance needs \"el\" param!");
				...
				try {
					...
					r("Init error", e), this.renderer && this.renderer.domElement && this.el.removeChild(this.renderer.domElement), this.options.backgroundColor && (console.log("[VANTA] Falling back to backgroundColor"), this.el.style.background = (h = this.options.backgroundColor, "number" == typeof h ? "#" + ("00000" + h.toString(16)).slice(-6) : h));
					return;
				}
				this.initMouse(), this.resize(), this.animationLoop();
				const a = window.addEventListener;
				a("resize", this.resize), window.requestAnimationFrame(this.resize), this.options.mouseControls && (a("scroll", this.windowMouseMoveWrapper), a("mousemove", this.windowMouseMoveWrapper)), this.options.touchControls && (a("touchstart", this.windowTouchWrapper), a("touchmove", this.windowTouchWrapper)), this.options.gyroControls && a("deviceorientation", this.windowGyroWrapper);
			}
			setOptions(e = {}) {
			...
			windowMouseMoveWrapper(e) {
				...
				if (!t) return !1;
				const i = e.clientX - t.left, o = e.clientY - t.top;
			...
			windowTouchWrapper(e) {
				...
				if (1 === e.touches.length) {
					const i = e.touches[0].clientX - t.left, o = e.touches[0].clientY - t.top;
					i >= 0 && o >= 0 && i <= t.width && o <= t.height && (this.mouseX = i, this.mouseY = o, this.options.mouseEase || this.triggerMouseMove(i, o));
				}
			}
			windowGyroWrapper(e) {
				const t = this.getCanvasRect();
				if (!t) return !1;
				const i = Math.round(2 * e.alpha) - t.left, o = Math.round(2 * e.beta) - t.top;
				i >= 0 && o >= 0 && i <= t.width && o <= t.height && (this.mouseX = i, this.mouseY = o, this.options.mouseEase || this.triggerMouseMove(i, o));
			}
			triggerMouseMove(e, t) {
				...
				const i = e / this.width, o = t / this.height;
			...
			isOnScreen() {
				const e = this.el.offsetHeight, t = this.el.getBoundingClientRect(), i = window.pageYOffset || (document.documentElement || document.body.parentNode || document.body).scrollTop, o = t.top + i;
			...
			destroy() {
				...
				const t = this.scene;
				t && t.children && i(t), this.renderer && (this.renderer.domElement && this.el.removeChild(this.renderer.domElement), this.renderer = null, this.scene = null), n.current === this && (n.current = null);
			}
		};
		const h = n.VantaBase;
		...
		class l extends h {
			constructor(e) {
				a = e.THREE || a, a.Color.prototype.toVector = function() {
					return new a.Vector3(this.r, this.g, this.b);
				}, super(e), this.updateUniforms = this.updateUniforms.bind(this);
			}
			init() {
			...
			updateUniforms() {
				const e = {};
				let t, i;
				for (t in this.options) i = this.options[t], -1 !== t.toLowerCase().indexOf("color") ? e[t] = {
					type: "v3",
					value: new a.Color(i).toVector()
				} : "number" == typeof i && (e[t] = {
					type: "f",
					value: i
				});
		...
		return c.prototype.defaultOptions = {
